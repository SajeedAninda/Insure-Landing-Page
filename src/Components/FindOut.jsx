...
const FindOut = () => {
    return (
        <div className='my-28'>
            <div className='w-[85%] mx-auto bg-[#2d2640] p-16 flex justify-between items-center find-out-background'>
                <h1 className='font-dmSerif text-[65px] text-white leading-[70px]'>
